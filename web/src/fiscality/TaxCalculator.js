...
/** @typedef {import('./Household.js').Household} Household */

/**
 * @typedef {Object} FiscalProfile
 * @property {Household} household
 * @property {number} taxableIncome
 * @property {boolean} [usePfu]
 */

/**
 * @typedef {Object} PlacementIncome
 * @property {number} assietteImposition
 * @property {boolean} [eligiblePfu]
 * @property {number} [deductionRevenus]
 * @property {number} [tauxSpecifique]
 */
...
export class TaxCalculator {
   ...
   * @param {...PlacementIncome} incomes - placement income details
   ...
   * @param {FiscalProfile} profile - tax profile containing household and taxableIncome
   ...
   * @param {Household} household - household with children and single parent flags
