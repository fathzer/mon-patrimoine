...
- Chaque type de placement (Compte courant, PEA, PER, PEE, Assurance vie, etc ...) fait l'objet d'un composant différent. Le système de modules de placement (plugins) est documenté dans [PLACEMENTS.md](PLACEMENTS.md).
